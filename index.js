...
setInterval(() => {
  http.get(`http://${process.env.PROJECT_DOMAIN}.repl.it`);
}, 280000);
...
client.on("ready", () => {
  ...
  client.login("NzMwNTYzOTU2OTQyNDM4NDIy.Xws3jw._HynrsJH1n94u4JI5PE11kR9SxU");
});
...
const prefix = "!"
const developers = "604301201651138561"
...
client.on("message", message => {
  ...
  ●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬●
[ ★・bot rules   |  قوانين البوت  ]

1) ممنوع عمل سبام للبوت لان يتبند

2)ممنوع الحديث عن الدين او سبه او مفاوضات دينيه

3)ممنوع التحدث عن السياسه   "

4)ممنوع الصور +18 او اى شي مخل بالادب 

5)ممنوع نشر صور من  مواقع التواصل الاجتماعى  بحقوق ملكيه

6) يجب قرائة كل  القوانين وتطبيقها

7)لاستخدام البوت  فى - اي روم اوامر او كلمة cmd
__
...
///////////////////////-------------//////////////////////
client.on("message", message => {
  if (message.content === prefix + "newcolore") {
...
//امر خاص لصاحب البوت لمعرفة خصائص سيرفرات التي يدخل فيها
...
///////////////////////-------------//////////////////////
client.on("message", message => {
  if (message.content.startsWith(prefix + "boty")) {
    if (message.author.bot || message.channel.type == "dm") return;
    let mention = new Discord.RichEmbed()
      .setColor("black")
      .setDescription(
        ` ✽  **Hi I'm System Bot**  
✽  **Support Server** [ https://discord.gg/2TjUxAD ] 
✽  **Bot orders** [ • **!help** • ]   `
      )
...
client.on("message", message => {
  ...
  if (message.content === prefix + "image") {
    const embed = new Discord.RichEmbed()
      ...
      .setTitle(`||Developer:aldolime|| | Avatar Server: ${message.guild.name}`)
  ...
  if (message.content.startsWith(prefix + "give")) {
    ...
    if (member) {
      if (role.startsWith("-")) {
        ...
        console.log(`hi`);
        if (!role1)
          return message.reply(`الرتبة غير موجودة بالسيرفر تأكد من الاسم`);
      ...
      if (role) {
        ...
        if (!role1)
          return message.reply(`الرتبة غير موجودة بالسيرفر تأكد من الاسم`);
        message.channel
          .send(`الرجاء الانتظار حتى يتم الانتهاء من الامر`)
          .then(msg => {
...
//امر اضهار البريميشن الخاص بلرول
...
//امر الارسال في الشاتات من قبل البوت
...
P.P.------------------------P.P.`
      ...
      .catch(err => {
        if (err == "DiscordAPIError: Cannot send messages to this user") {
          return message.channel.send(
            "**للأسف , لديك اعدادات خصوصية لاتسمح لي بأرسال رسائل خاصة لك **"
          );
        }
      });

    message.channel.send("**تم ارسال الحساب في الخاص | ☑ **");
  }
});
...
client.on("message", function(message) {
  if (message.content.startsWith(prefix + "report")) {
    ...
    let messageReason = message.content
      ...
      .slice(2)
      .join(" ");
    if (!messageReason) return message.reply("**اكتب سبب الابلاغ**");
...
//امر الحصول على عدد الاشخاص المبندين
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "bans")) {
    message.guild
      .fetchBans()
      .then(bans =>
        message.channel.send(`${bans.size} عدد الأشخاص المبندة من السيرفر `)
      )
      .catch(console.error);
  }
});
...
//امر عمل روم ل عدد اعظاء السيرفر
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "bk")) {
    ...
    if (!args)
      return message.reply(
        "**يجب عليك كتابة كلمة او ��ملة لإرسال البرودكاست**"
      );
...
//////////-----------////////////
client.on("message", message => {
  if (message.content.startsWith(prefix + "vnew")) {
    let args = message.content.split(" ").slice(1);
    var nam = args.join(" ");
...
//امر الكونتيكت لمراسلة صاحب البوت
...
==================================================
(سيرفر البوت للاستفسارات)




https://discord.gg/WTkSmXx



==================================================
 **__Done__** :white_check_mark:
==================================================
   `);
  }
});
...
(:white_check_mark:** يجب وضع البوت تحت رتبة الاونر شيب لتعمل الاوامر بشكل صحيح **:white_check_mark:)
...
\`${prefix} id\` :لمعرفة معلومات عن نفسك
...
\`${prefix}link\` : اكتب link بالشات يجيك رابط السيرفر خاص
==================================================
**__Done__** :white_check_mark:
==================================================
  `);
...
\`${prefix}talk\` : امر الارسال في الشاتات من قبل البوت
\`${prefix}perms\` :امر اضهار البريميشن الخاص بلرول
\`${prefix} bk\`:لعمل برودكاست لسيرفر1
\`${prefix} bc\`:لعمل برودكاست لسيرفر2
\`${prefix} obc\`:لعمل برودكاست لسيرفر3
==================================================
 **__Done__** :white_check_mark:
==================================================
   `);
...
==================================================
\`${prefix} vnew\`:لعمل روم صوت موقت
\`${prefix} contact\`:لمراسلة صاحب البوت وارسال المشاكل المتعلقة بلبوت
\`${prefix} rolls\`:لمعرفة رولات السيرفر
\`${prefix} members\`:لمعرفة معلومات حول حالات الاعظاء
\`${prefix} report\`:امر الابلاغ عن شخص يسئ لسيرفر او للبوت
\`${prefix} setmember\`:لعمل روم صوتي لعدد اعظاء السيرفر
\`${prefix} bans\` :امر الحصول على عدد الاشخاص المبندين 
\`${prefix} data\` :امر معرفة التاريخ واليوم والشهر
\`${prefix} bans\` :امر الحصول على عدد الاشخاص المبندين
\`${prefix} emojilist\` :امر اظهار اموجيات السيرفر
\`${prefix} vonline\`  :امر الفويس اون لاين
\`${prefix} newcolore\`   :امر تكوين الوان
\`${prefix} boty\`   :امر دعم تبع البوت
\`${prefix} topinv\`   :امر عدد الانفايتات
\`${prefix} ruls \`  :امر معرفة قوانين البوت
\`${prefix} فواكه\`:امر ترفيهي
==================================================
 **__Done__** :white_check_mark:
==================================================
   `);
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "setby")) {
    ...
    message.channel.send(
      `**${args}.  | :ballot_box_with_check: |لقد تم تشغيل المغادرة هنا**`
    ); //By ItzTexo
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "ping")) {
    ...
    let embed = new Discord.RichEmbed()
      .setAuthor(message.author.username, message.author.avatarURL)
      .setColor("#5016f3")
      .addField("**وقت الاستلام :**", msg + " ms :signal_strength: ")
      .addField("**وقت الأرسال:**", api + " ms :signal_strength: ")
      .setTimestamp();
    message.channel.send({ embed: embed });
  }
});
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "link") {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .setAuthor(client.user.username, client.user.avatarURL)
      .setAuthor(client.user.username, client.user.avatarURL)
      .setFooter("Developer: " + message.author.tag);
